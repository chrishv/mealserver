...
object domain_worksheet {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(193); 
  ...
  val ben = new Person(1,"Ben","Mulhern","ben.mulhern@jhc.co.uk",Tuckers.bacon);System.out.println("""ben  : uk.co.benmulhern.mealserver.domain.Person = """ + $show(ben ));$skip(73); 
  ...
  val order2 = List((ben,ben.usualItem),(matthew,matthew.usualItem));System.out.println("""order2  : List[(uk.co.benmulhern.mealserver.domain.Person, uk.co.benmulhern.mealserver.domain.Sandwich)] = """ + $show(order2 ));$skip(40); val res$0 = 
